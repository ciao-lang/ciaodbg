...
:- doc(module, "This module implements basic facilities for regression
   testing. For a module with regression test queries in it (see
   @lib{regrtestdecls}), this library provides a tests execution
   mechanism and test results manipulations.  ").
